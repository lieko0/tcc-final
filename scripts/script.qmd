...
# tr.labels.matrix <- as.matrix(scene$fold3$tr$labels)
# ts.labels.matrix <- as.matrix(scene$fold3$ts$labels)
# dplyr::glimpse(tr.labels.matrix)
# dplyr::glimpse(ts.labels.matrix)

# X.train <- as.matrix(scene$fold3$tr$attr)
# X.test <- as.matrix(scene$fold3$ts$attr)
# Y.train <- tr.labels.matrix
# Y.test <- ts.labels.matrix
